...
public class TinyDB {
    ...
    public ArrayList<PopularDomains> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<PopularDomains> playerList =  new ArrayList<PopularDomains>();

        for(String jObjString : objStrings){
            PopularDomains player  = gson.fromJson(jObjString,  PopularDomains.class);
    ...
    public void putListObject(String key, ArrayList<PopularDomains> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(PopularDomains player: playerList){
